                      ...
                      child: Consumer<MarchantProvider>(
                        builder: (context, provider, child) {
                          if (provider.marchantList.isNotEmpty && provider.merhcanthavePickup()) {
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          trailing:
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              value: allSelected == true ? allSelected : pickupbools[serial],
                                                                            ),
                                                                          ),
                                                                          title:
                                                                              SizedBox(
                                                                            child:
                                                                              ...
                                                                              children: [
                                                                                ...
                                                                                Expanded(
                                                                                    child: Container(
                                                                                  decoration: BoxDecoration(color: logogold.withOpacity(0.4), border: Border.all(), borderRadius: BorderRadius.circular(12)),
                                                                                  child: Padding(
                                                                                            ...
                                                                                            Container(
                                                                                              child: Row(
                                                                                                children: [
                                                                                                  ...
                                                                                                  const Text(
                                                                                                    "CusName: ",
                                                                                                    style: TextStyle(color: logoblue, fontWeight: FontWeight.w500),
                                                                                                  ),
                                                                                                  Text("${item.recipientName21}", style: const TextStyle(color: logoblue, fontWeight: FontWeight.w500))
                                                                                                ],
                                                                                              ),
                                                                                            ),
                                                                                            Container(
                                                                                              child: Row(
                                                                                                children: [
                                                                                                  const Icon(Icons.phone, color: logoblue),
                                                                                                  const Text("CusPhone: ", style: TextStyle(color: logoblue, fontWeight: FontWeight.w500)),
                                                                                                  Text("${item.recipientPhone20}", style: const TextStyle(color: logoblue, fontWeight: FontWeight.w500))
                                                                                                ],
                                                                                              ),
                                                                                            ),
                                                                                            Row(
                                                                                              children: [
                                                                                                const Icon(Icons.numbers, color: logoblue),
                                                                                                const Text("Invoice: ", style: TextStyle(color: logoblue, fontWeight: FontWeight.w500)),
                                                                                                Text("${item.id}", style: const TextStyle(color: logoblue, fontWeight: FontWeight.w500))
                                                                                              ],
                                                                                            )
                                                                                          ],
                                                                                        ),
                            ...
                            return const Center(
                                child: Text('Pick up list is empty'));
                          }
                        },
                      ),
                    ),
          ...
          title: ListTile(
            ...
            title: Row(
              ...
              children: [
                ...
                provider.statusPickupList![index].id != null
                    ? Text('Invoice: ' +
                        provider.statusPickupList![index].id!.toString())
                    : Text('Invoice: N/A')
              ],
            ),
            dense: true,
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              Expanded(
                                  child: provider.statusPickupList![index]
                                              .merchantInvoice !=
                                          null
                            ...
                            children: [
                              ...
                              Expanded(
                                child: provider.statusPickupList![index]
                                            .merchantInvoice !=
                                        null
                                    ? Text(provider.statusPickupList![index]
                                        .merchantInvoice!)
                                    : Text('N/A'),
                              )
                            ],
