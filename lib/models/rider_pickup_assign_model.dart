...
//
//     final assignPickupReturnModel = assignPickupReturnModelFromJson(jsonString);

import 'dart:convert';

AssignPickupReturnModel assignPickupReturnModelFromJson(String str) => AssignPickupReturnModel.fromJson(json.decode(str));

String assignPickupReturnModelToJson(AssignPickupReturnModel data) => json.encode(data.toJson());

class AssignPickupReturnModel {
  String? riderUserId;
  List<AssignBranchReturnPickupList>? assignBranchPickupList;

  AssignPickupReturnModel({
    this.riderUserId,
    this.assignBranchPickupList,
  });

  factory AssignPickupReturnModel.fromJson(Map<String, dynamic> json) => AssignPickupReturnModel(
    riderUserId: json["rider_user_id"],
    assignBranchPickupList: json["assign_branch_pickup_list"] == null ? [] : List<AssignBranchReturnPickupList>.from(json["assign_branch_pickup_list"]!.map((x) => AssignBranchReturnPickupList.fromJson(x))),
  );

  Map<String, dynamic> toJson() => {
    "rider_user_id": riderUserId,
    "assign_branch_pickup_list": assignBranchPickupList == null ? [] : List<dynamic>.from(assignBranchPickupList!.map((x) => x.toJson())),
  };
}

class AssignBranchReturnPickupList {
  int? id;
  int? servicesId1;
  int? iProductTypeId2;
  int? iPriorityId3;
  ...
  dynamic customerReturnAmountFrom;
  ...
  int? creator;
  dynamic modifier;
  DeliveryBoyId? assignBranchPickupListDeliveryBoyId;
  dynamic iRelation;
  ...
  AssignBranchReturnPickupList({
    ...
    this.creator,
    this.modifier,
    this.assignBranchPickupListDeliveryBoyId,
    this.iRelation,
    this.iReturnCause,
    this.services,
    this.iProductType,
  ...
  factory AssignBranchReturnPickupList.fromJson(Map<String, dynamic> json) => AssignBranchReturnPickupList(
    id: json["id"],
    ...
    assignBranchPickupListDeliveryBoyId: json["delivery_boy_id_"] == null ? null : DeliveryBoyId.fromJson(json["delivery_boy_id_"]),
  ...
  Map<String, dynamic> toJson() => {
    ...
    "creator": creator,
    "modifier": modifier,
    "delivery_boy_id_": assignBranchPickupListDeliveryBoyId?.toJson(),
