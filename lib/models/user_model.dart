...
class UserModel {
    ...
    Map<String, dynamic> toJson() {
        ...
        data['delivery_cost_packages_id_f'] = this.deliveryCostPackagesIdF;
        data['delivery_cost_packages'] = this.deliveryCostPackages;
        return data;
    }
}
...
class GetUser {
    ...
    String? branchId;
    Null? deliveryCostPackagesIdF;
    Null? riderCommissionPackagesIdF;
    ...
    Map<String, dynamic> toJson() {
        ...
        data['delivery_cost_packages_id_f'] = this.deliveryCostPackagesIdF;
        data['rider_commission_packages_id_f'] = this.riderCommissionPackagesIdF;
        return data;
    }
}
