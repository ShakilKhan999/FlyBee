...
MerchantPickUpModel merchantPickUpModelFromJson(String str) => MerchantPickUpModel.fromJson(json.decode(str));

String merchantPickUpModelToJson(MerchantPickUpModel data) => json.encode(data.toJson());

class MerchantPickUpModel {
    String? riderUserId;
    String? riderBranchId;
    ...
    factory MerchantPickUpModel.fromJson(Map<String, dynamic> json) => MerchantPickUpModel(
        riderUserId: json["rider_user_id"],
        riderBranchId: json["rider_branch_id"],
        assignBranchPickupList: json["assign_branch_pickup_list"] == null ? [] : List<AssignBranchPickupList>.from(json["assign_branch_pickup_list"]!.map((x) => AssignBranchPickupList.fromJson(x))),
    );

    Map<String, dynamic> toJson() => {
        "rider_user_id": riderUserId,
        "rider_branch_id": riderBranchId,
        "assign_branch_pickup_list": assignBranchPickupList == null ? [] : List<dynamic>.from(assignBranchPickupList!.map((x) => x.toJson())),
    };
}

class AssignBranchPickupList {
    int? id;
    int? servicesId1;
    int? iProductTypeId2;
    int? iPriorityId3;
    ...
    int? creator;
    dynamic modifier;
    dynamic assignBranchPickupListDeliveryBoyId;
    dynamic iRelation;
    ...
    factory AssignBranchPickupList.fromJson(Map<String, dynamic> json) => AssignBranchPickupList(
        id: json["id"],
        ...
        assignBranchPickupListDeliveryBoyId: json["delivery_boy_id_"],
    ...
    Map<String, dynamic> toJson() => {
        ...
        "creator": creator,
        "modifier": modifier,
        "delivery_boy_id_": assignBranchPickupListDeliveryBoyId,
