...
RiderPickUpStatusModel riderPickUpStatusModelFromJson(String str) => RiderPickUpStatusModel.fromJson(json.decode(str));

String riderPickUpStatusModelToJson(RiderPickUpStatusModel data) => json.encode(data.toJson());

class RiderPickUpStatusModel {
    String? riderUserId;
    ...
    factory RiderPickUpStatusModel.fromJson(Map<String, dynamic> json) => RiderPickUpStatusModel(
...
class StatusPickupList {
    ...
    int? creator;
    dynamic modifier;
    dynamic statusPickupListDeliveryBoyId;
    IRelation? iRelation;
    ...
    factory StatusPickupList.fromJson(Map<String, dynamic> json) => StatusPickupList(
        ...
        statusPickupListDeliveryBoyId: json["delivery_boy_id_"],
    ...
    Map<String, dynamic> toJson() => {
        ...
        "creator": creator,
        "modifier": modifier,
        "delivery_boy_id_": statusPickupListDeliveryBoyId,
